...
public class ConsumeApiAddNewPet implements Task {
    private final String body;

    public ConsumeApiAddNewPet(String body) {
        this.body = body;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        SerenityRest.rest();
        actor.attemptsTo(
                Post.to(API_PET_RESOURCE_ADD_NEW_PET.getEndpoint()).with(request -> request.contentType(ContentType.JSON)
                        .body(body)
    ...
    public static ConsumeApiAddNewPet createNewPet(String body) {
        return Instrumented.instanceOf(ConsumeApiAddNewPet.class).withProperties(body);
    }
